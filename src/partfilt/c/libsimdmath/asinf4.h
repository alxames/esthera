...
static inline vec_float4  __attribute__((__always_inline__))
      ...
      z = vec_sel(z1,z,(vec_uint4)x_smaller_1e_4);
      
      z1 = z+z;
      z1 = CF4_PIO2F-z1;

      z = vec_sel(z,z1,(vec_uint4)x_larger_05);
      VEC_XOR(z,sign);
      return z ;
}
...
static inline vec_float4  __attribute__((__always_inline__))
      ...
      x = vec_sel( x, _sqrtf4(vec_nmsub(a,CF4_05,CF4_05)), (vec_uint4)a_larger_05);

      x = _asinf4( x );
      x2 = x+x;
      
      z = vec_sel(x2, CF4_PIF-x2, (vec_uint4)sign);
      z = vec_sel(CF4_PIO2F - x, z, (vec_uint4)a_larger_05);      
#ifdef __SPU__
